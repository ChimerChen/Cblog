...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('users', '0005_userprofile_gexing_alter_userprofile_desc'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.TextField(blank=True, max_length=200, verbose_name='分类描述')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.tag', verbose_name='文章标签')),
            ],
            options={
                'verbose_name': '文章',
